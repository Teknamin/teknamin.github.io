...
All LLM evaluations were run with temperature set to 0. This reduces sampling variance, but it does not guarantee identical behavior across provider revisions, serving infrastructure, or upstream model changes.
